...
class FileList
{
    ...
    public function getIndexLists($order)
    {
        ...
        $ch2->origin = 99999;
        $ch2->cnt = 99999;
        $ch2->nickname = 'Changledick长乐的';
        $ch2->headicon = 'http://img08.oneniceapp.com/upload/avatar/2017/05/27/969ddaa082303824fb4809c75818377f.jpg';
        $ch2->profile = '';
        ...
        $ch1->origin = 99999;
        $ch1->cnt = 99999;
        $ch1->nickname = '王露茜LucyW';
        $ch1->headicon = 'http://img08.oneniceapp.com/upload/avatar/2017/07/20/c5a152a3465a93cea384f15367b27991.jpg';
        $ch1->profile = '';
        $ch1->originInfo = $ch2;
        $ch1->trueName = $chName;
        $ch1->trueCnt = $chCnt;
        ...
        $ch3->origin = 99999;
        $ch3->cnt = 99999;
        $ch3->nickname = 'Changledick长乐的';
        $ch3->headicon = 'http://img08.oneniceapp.com/upload/avatar/2017/05/27/969ddaa082303824fb4809c75818377f.jpg';
        $ch3->profile = '';
        ...
        $ch4->origin = 99999;
        $ch4->cnt = 99999;
        $ch4->nickname = '丁丁丁timo';
        $ch4->headicon = 'http://img08.oneniceapp.com/upload/avatar/2016/01/16/9867580490307229034752275fd808f7.jpg';
        $ch4->profile = '';
        $ch4->originInfo = $ch3;
        ...
        $mx2->origin = 99999;
        $mx2->cnt = 99999;
        $mx2->nickname = 'JungSukin';
        $mx2->headicon = 'http://img08.oneniceapp.com/upload/avatar/2016/12/31/0aa35471eb2f26aa569160212e37fd95.jpg';
        $mx2->profile = '';
        ...
        $mx1->created_at = '';
        $mx1->updated_at = '';
        $mx1->label = '秀恩爱得看你的腰力噢';
        $mx1->origin = 99999;
        $mx1->cnt = 99999;
        $mx1->nickname = 'lucizi';
        $mx1->headicon = 'http://img08.oneniceapp.com/upload/avatar/2015/03/14/abe2fdab96aad4b51384937e0839cb6c.jpg';
        $mx1->profile = '';
        $mx1->originInfo = $mx2;
        $mx1->trueName = $mxName;
        $mx1->trueCnt = $mxCnt;
        ...
        $mx3->origin = 99999;
        $mx3->cnt = 99999;
        $mx3->nickname = 'JungSukin';
        $mx3->headicon = 'http://img08.oneniceapp.com/upload/avatar/2016/12/31/0aa35471eb2f26aa569160212e37fd95.jpg';
        $mx3->profile = '';
        ...
        $mx4->created_at = '';
        $mx4->updated_at = '';
        $mx4->label = '秀恩爱得看你的腰力噢';
        $mx4->origin = 99999;
        $mx4->cnt = 99999;
        $mx4->nickname = '施沛岑carol';
        $mx4->headicon = 'http://img08.oneniceapp.com/upload/avatar/sina/2014/02/14/350781_1402812361.jpg';
        $mx4->profile = '';
        $mx4->originInfo = $mx3;
