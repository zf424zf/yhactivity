...
@section('content')
    <div class="bg page" data-config='<?php echo app('wechat')->js->config(array('onMenuShareTimeline', 'onMenuShareAppMessage')) ?>'>
        ...
        <div class="world-video">
            <video controls poster="{{$data['cover']}}" x5-video-player-type="h5" width="200" playsinline  class="video" autoplay>
...
{{--            <a href="" class="play"><img src="{{staticFile('images/active/world-video-play.png')}}" alt="下一个视屏"></a>--}}
        ...
        <p class="world-video-next">
            <a href="http://m.oneniceapp.com/go/toNice?action=storyPublish?lens_id={{$jtId}}" class="btn mar"><img src="{{staticFile('images/active/world-video-recoding.png')}}" alt=""></a>
